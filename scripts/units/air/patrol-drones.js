...
t1Patrol.ammoType = AmmoTypes.power;
...
laserHeavyBolter.shots = 2;
laserHeavyBolter.recoil = 0.4;
laserHeavyBolter.shootSound = Sounds.beam;
tractorBeamWeapon.reload = 70;
...
t4Patrol.abilities.add(new ShieldRegenFieldAbility(120, 150, 60 * 16, 32));
